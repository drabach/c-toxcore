...
static void test_basic(void)
{
    ...
    TCP_Server *tcp_s = new_tcp_server(logger, mem, rng, ns, USE_IPV6, NUM_PORTS, ports, self_secret_key, nullptr, nullptr, nullptr);
...
static void test_client(void)
{
    ...
    TCP_Client_Connection *conn = new_tcp_connection(logger, mem, mono_time, rng, ns, &ip_port_tcp_s, self_public_key, f_public_key, f_secret_key, nullptr, nullptr, nullptr);
    ...
    TCP_Client_Connection *conn2 = new_tcp_connection(logger, mem, mono_time, rng, ns, &ip_port_tcp_s, self_public_key, f2_public_key,
                                   f2_secret_key, nullptr, nullptr, nullptr);
...
static void test_client_invalid(void)
{
    ...
    TCP_Client_Connection *conn = new_tcp_connection(logger, mem, mono_time, rng, ns, &ip_port_tcp_s,
                                  self_public_key, f_public_key, f_secret_key, nullptr, nullptr, nullptr);
    ck_assert_msg(conn != nullptr, "Failed to create a TCP client connection.");
