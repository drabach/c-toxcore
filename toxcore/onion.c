 ...
 * return 0 on success.
 */
int send_onion_response(const Logger *log, const Tor_Transport *tran,
                        ...
                        const uint8_t *ret)
{
    ...
    if (tor_transport_send((Tor_Transport *)tran, dest->ip.ip.onion, dest->port, nullptr, packet, packet_size) != 1) {
        return -1;
    }
...
static void handle_send_initial(void *_Nonnull object, const IP_Port *_Nonnull source, const uint8_t *_Nonnull packet, uint16_t length, void *_Nonnull userdata)
{
    ...
    onion_send_1(onion, plain, len, source, packet + 1);
}
...
int onion_send_1(const Onion *onion, const uint8_t *plain, uint16_t len, const IP_Port *source, const uint8_t *nonce)
{
    ...
    tor_transport_send(onion->tran, send_to.ip.ip.onion, send_to.port, nullptr, data, data_len);
    Ip_Ntoa ip_str;
...
static void handle_send_1(void *_Nonnull object, const IP_Port *_Nonnull source, const uint8_t *_Nonnull packet, uint16_t length, void *_Nonnull userdata)
{
    Onion *onion = (Onion *)object;
...
static void handle_send_2(void *_Nonnull object, const IP_Port *_Nonnull source, const uint8_t *_Nonnull packet, uint16_t length, void *_Nonnull userdata)
{
    Onion *onion = (Onion *)object;
...
static void handle_recv_3(void *_Nonnull object, const IP_Port *_Nonnull source, const uint8_t *_Nonnull packet, uint16_t length, void *_Nonnull userdata)
{
    Onion *onion = (Onion *)object;
...
static void handle_recv_2(void *_Nonnull object, const IP_Port *_Nonnull source, const uint8_t *_Nonnull packet, uint16_t length, void *_Nonnull userdata)
{
    Onion *onion = (Onion *)object;
...
static void handle_recv_1(void *_Nonnull object, const IP_Port *_Nonnull source, const uint8_t *_Nonnull packet, uint16_t length, void *_Nonnull userdata)
{
    Onion *onion = (Onion *)object;
    ...
    if (onion->recv_1_function != nullptr &&
        ...
        onion->recv_1_function(onion->callback_object, &send_to, packet + (1 + RETURN_1), data_len);
        return;
    }

    tor_transport_send(onion->tran, send_to.ip.ip.onion, send_to.port, nullptr, packet + (1 + RETURN_1), data_len);
}
...
Onion *new_onion(const Logger *log, const Memory *mem, const Mono_Time *mono_time, const Random *rng, DHT *dht)
{
    ...
    onion->log = log;
    onion->dht = dht;
    onion->tran = dht_get_transport(dht);
    ...
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_SEND_INITIAL, &handle_send_initial, onion);
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_SEND_1, &handle_send_1, onion);
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_SEND_2, &handle_send_2, onion);

    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_RECV_3, &handle_recv_3, onion);
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_RECV_2, &handle_recv_2, onion);
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_RECV_1, &handle_recv_1, onion);
...
void kill_onion(Onion *onion)
{
    ...
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_SEND_INITIAL, nullptr, nullptr);
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_SEND_1, nullptr, nullptr);
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_SEND_2, nullptr, nullptr);

    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_RECV_3, nullptr, nullptr);
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_RECV_2, nullptr, nullptr);
    tor_transport_register_handler(onion->tran, NET_PACKET_ONION_RECV_1, nullptr, nullptr);
